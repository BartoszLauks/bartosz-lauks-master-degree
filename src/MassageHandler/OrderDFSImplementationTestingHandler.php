...
#[AsMessageHandler]
readonly class OrderDFSImplementationTestingHandler
{
    ...
    public function __invoke(DFSImplementationTesting $algorithmToTest): void
    {
    ...
    private function getComputationalComplexity(Test $test) : ComputationalComplexity
    {
        ...
        if (!$complexity) {
            $complexityPath = sprintf('%s%s', $this->parameterBag->get('algorithms_dir_DFS'), 'computationalComplexity');
